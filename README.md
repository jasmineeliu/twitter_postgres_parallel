...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/jasmineeliu/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |   18m45.808s              |  1m45.064s                | 
| `pg_normalized_batch`  |            3m19.231s      |      0m13.038s            | 
| `pg_denormalized`      |  0m14.599s                |      0m2.935s             | 
